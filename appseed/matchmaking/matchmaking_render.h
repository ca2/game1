...
namespace matchmaking
{
   ...
   class CLASS_DECL_APP_CORE_MATCHMAKING render :
   ...
   public:
      ...
      string get_matchmaking() {
         synch_lock slText(m_pmutexText);
         string str(m_strHelloMultiverse.c_str());
         return str;
      }
      ...
      virtual void matchmaking_render();
      virtual void matchmaking_draw();
      virtual void matchmaking_render(::draw2d::dib * pdib);
      //virtual void matchmaking_render(::draw2d::dib * pdib);

      virtual void matchmaking_render_full_view(::draw2d::dib * pdib);
      virtual void matchmaking_render_lite_view(::draw2d::dib * pdib);
