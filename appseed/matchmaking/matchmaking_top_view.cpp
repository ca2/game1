...
namespace hellomultiverse
{
   ...
   void top_view::on_create_views()
   {
      ...
      m_peditview = create_view < edit_view >(NULL,::null_rect(),get_pane_holder(0),"top_edit_view");
      ...
      m_ptoggleview = create_view < toggle_view >(NULL,::null_rect(),get_pane_holder(1),"top_toggle_view");
   ...
   bool top_view::IsWindowVisible()
   {

      return ::user::split_view::IsWindowVisible() && !GetTopLevel()->frame_is_transparent();
