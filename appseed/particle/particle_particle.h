...
namespace particle
{
   ...
   public:
      ...
      struct Ball : public Element
      {
         ...
         void update(float dt, particle * pparticle);
         void draw(::draw2d::graphics * pgraphics);
      ...
      struct Paddle: public Element
      {
         ...
         void key_left_up(particle * pparticle);

         void key_right_up(particle * pparticle);

         void key_down(particle * pparticle);
      ...
      struct Brick: public Element
      {
         ...
         void draw(::draw2d::graphics * pgraphics, particle * pparticle);
      ...
      particle(::aura::application * papp);
